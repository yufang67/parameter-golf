...
class Hyperparameters():
    ...
    # LoRA TTT params
    ttt_lora_rank = int(os.environ.get('TTT_LORA_RANK', 64)) # 96
    ttt_lora_lr = float(os.environ.get('TTT_LORA_LR', 5e-5)) #0.0001
    ttt_chunk_size = int(os.environ.get('TTT_CHUNK_SIZE', 48)) #32
